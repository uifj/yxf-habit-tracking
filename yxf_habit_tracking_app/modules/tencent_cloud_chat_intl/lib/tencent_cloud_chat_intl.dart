...
class TencentCloudChatIntl extends ChangeNotifier {
  ...
  static String localizedDateString(int timestamp, BuildContext context) {
    ...
    DateFormat dateFormat = date.year == currentYear
  ...
  /// print(formattedTime); // Output: "11:00 AM"
  /// ```
  static String formatTimestampToHumanReadable(
    int timestamp,
    ...
    if (seconds > 60) {
      ...
      if (min > 60) {
        ...
        if (hour % 24 == 0) {
          ...
          int day = ((seconds ~/ 60) ~/ 60) ~/ 24;
          timeStr =
              '$day${tL10n.day}$hour${tL10n.hour}$min${tL10n.min}$second${tL10n.second}';
        }
      }
    }
