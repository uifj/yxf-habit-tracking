...
class CallingMessage {
  ...
  final CallParticipantRole _participantRole = CallParticipantRole.unknown;
  ...
  _fromJSON(json) {
    ...
    if ((businessID == 'av_call' || businessID == 'rtc_call')) {
  ...
  String getContent() {
    ...
    if (_participantType == CallParticipantType.c2c) {
      ...
      if (_protocolType == CallProtocolType.reject) {
        ...
        display =
            isCaller ? tL10n.callLineBusyCaller : tL10n.callLineBusyCallee;
      ...
      if (_protocolType == CallProtocolType.send) {
        ...
        if (inviteeList != null && inviteeList!.isNotEmpty) {
          ...
          if (mutableContent.isNotEmpty) {
            mutableContent =
                mutableContent.substring(0, mutableContent.length - 1);
          }
        }
  ...
  //   } else if (v2timMessage!.friendRemark != null &&
  //       v2timMessage!.friendRemark!.isNotEmpty) {
  //     displayName = v2timMessage!.friendRemark!;
  //   } else if (v2timMessage!.nickName != null &&
  //       v2timMessage!.nickName!.isNotEmpty) {
