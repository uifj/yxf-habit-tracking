      ...
      NavigationBarData(
        ...
        selectedIcon: Stack(
          ...
          children: [
            ColorFiltered(
              colorFilter:
                  ColorFilter.mode(colorTheme.primaryColor, BlendMode.srcATop),
              child: Image.asset(
          ...
          children: [
            ColorFiltered(
                colorFilter: ColorFilter.mode(
                    colorTheme.secondaryTextColor.withOpacity(0.3),
                    BlendMode.srcATop),
                child: Image.asset(
                  "assets/chat.png",
                  width: 24,
              ...
              child: UnconstrainedBox(
                ...
                child: Container(
                  ...
                  child: Text(
                    ...
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                        color: colorTheme.appBarBackgroundColor, fontSize: 10),
                    textAlign: TextAlign.center,
                  ),
                ),
              )),
