...
class TaskRepositoryImpl implements TaskRepository {
  final SharedPrefsHelper _dbHelper;
  // final NotifyHelper _notifyHelper;
  final TaskServices _taskServices;

  TaskRepositoryImpl({
    required SharedPrefsHelper dbHelper,
  ...
  Future<void> initializeDatabase() async {
    try {
      await SharedPrefsHelper.initDb();
    } catch (e) {
  ...
  Future<List<Task>> getTasks() async {
    try {
      ...
      final List<Map<String, dynamic>> maps = await SharedPrefsHelper.query();
  ...
  Future<List<Task>> getTasksWhere({
    ...
    try {
      ...
      final List<Map<String, dynamic>> maps =
          await SharedPrefsHelper.queryWhere(
        where: where,
        whereArgs: whereArgs,
        orderBy: orderBy,
        limit: limit,
  ...
  Future<Task> addTask(Task task) async {
    try {
      ...
      // 添加到本地数据库
      final taskId = await SharedPrefsHelper.insert(task);
  ...
  Future<Task> updateTask(Task task) async {
    try {
      ...
      // 更新本地数据库
      await SharedPrefsHelper.update(task);
  ...
  Future<void> deleteTask(Task task) async {
    try {
      ...
      // 从本地数据库删除
      await SharedPrefsHelper.delete(task);
  ...
  Future<Task> markTaskCompleted(Task task) async {
    try {
      ...
      await SharedPrefsHelper.update(completedTask);
  ...
  Future<List<Task>> addTasks(List<Task> tasks) async {
    try {
      ...
      await SharedPrefsHelper.insertBatch(tasks);
  ...
  Future<void> deleteAllTasks() async {
    try {
      ...
      // 清空本地数据
      await SharedPrefsHelper.clearAllTasks();
